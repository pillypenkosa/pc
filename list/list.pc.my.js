...
const arrListPcMy = [

	{
		...
		keyval: [
			...
			{ k: 'Об\'єм RAM' 					, v: '64 Гб', },
			{ k: 'Частоти пам\'яті' 	, v: '2133 МГц, 2400 МГц, 2666 МГц, 2800 (O.C.) МГц, 2933 (O.C.) МГц, 3000 (O.C.) МГц, 3200 (O.C.) МГц, 3333 (O.C.) МГц, 3400 (O.C.) МГц, 3466 (O.C.) МГц, 3600 (O.C.) МГц, 3733 (O.C.) МГц, 3866 (O.C.) МГц, 4000 (O.C.) МГц', },
		...
		site: [ 
			...
			{ title: 'Процессоры' 			, href: 'https://www.gigabyte.com/Motherboard/Z370-HD3-rev-10/support#support-cpu', },
		],
	},
	{
		title: 'CPU',
